...
- Sensibility: :: passive/receptive; sensory intuitions arise from the
  affection of sensibility by objects[fn:4][fn:6]
- Understanding: :: active/spontaneous; conceptual judgments arise via
  discursive acts of the understanding[fn:7]
...
- Objective representation: :: A conscious representation of a
  mind-independent feature of (empirical) reality[fn:13]
...
**** The Metaphysical Exposition[fn:8]
   :PROPERTIES:
   :CUSTOM_ID: the-metaphysical-exposition164651
   :END:

- Three questions about space:[fn:9]
...
**** The Transcendental Exposition[fn:12]
   :PROPERTIES:
   :CUSTOM_ID: the-transcendental-exposition165125
   :END:

- The 'Argument from Geometry'[fn:14]
...
\newthought{Shabel's Alternative}:[fn:15]
...
[fn:14] Geometry is a science that determines the properties of space
...
[fn:15] The "argument from geometry" does not analyze geometric
...
- Transcendental Idealism: :: No thing as it is in itself appears in
  space and time[fn:16]

\newthought{Allais' Interpretation}:

1. Intuition necessarily involves the presentation of an object[fn:17]
...
[fn:16] I understand by the *transcendental idealism* of all appearances
...
[fn:17] How is it possible to intuit something /a priori/? An intuition
...
[fn:18] How can an outer intuition inhabit the mind that precedes the
...
\newpage
\newthought{Van Cleve's Interpretation}:[fn:19]
...
- Two objections to (2)
  ...
  2. The reducibility premise makes advertance to incongruent
     counterparts unnecessary[fn:20]

[fn:19] @van-cleve1999, 47.

[fn:20] once armed with the reducibility principle, Kant need not have
...
- All cognition demands a synthesis of representation[fn:14]
...
- §15 On the possibility of a combination as such
  ...
  - what does Kant mean by 'combination' [/Verbindung/][fn:20]
  - why can't combination be given in intuition?[fn:21]
  - what is the connection of the categories with combination?[fn:22]

[fn:21] the combination (/conjunctio/) of a manifold in general can
...
[fn:22] Now the representation of a composite, as such, is not a mere
...
1. I am conscious of the identity of myself as the subject of different
   self- attributions of mental states.[fn:13]
...
- Against Synthesis
  ...
  - Kant is faced with a dilemma regarding the need for synthesis[fn:15]
...
- Against the need for the categories
  ...
  - why think that synthesis requires the categories?
    ...
    2. judging requires the application of categories[fn:16]
...
- Thinking is not /cognizing/[fn:13]
...
- There is no intentionality without synthesis[fn:14]
...
- against premise (1) --- Kant seems to deny both that:
  ...
  1. we think in terms of images[fn:17]
  2. we infer from the existence and character of images to the
     existence and character of their causes[fn:18]
...
- We cannot make sense of Kant's arguments concerning pure intuition in
  ...
  depend on synthesis according to the categories of quantity[fn:19]
  ...
  - Kant consistently characterizes the nature of the understanding's
    ...
    prior to their parts characteristic of God[fn:20]
...
- Kant's solution is /not/ to appeal to a /tertium quid/ but rather to
  ...
  in both the formation and the application of concepts'[fn:13]
...
- The error of traditional metaphysics is thus to mistake a 'regulative'
  principle for a 'constitutive' one[fn:15]
...
- All paralogisms are syllogistic inferences[fn:6] with three
  ...
  - formally invalid but has true premises[fn:13]
...
- The 'logical' use of 'I' is mistaken for a 'real' use in denoting a
  ...
  - Substance_{1}: a being whose existence is such that it can never
    /inhere/ in anything else[fn:12][fn:14]
...
- Known as the 'Achilles' argument[fn:15]
...
\newthought{The 'Nervus Probandi' of Achilles}:[fn:16]
...
- Kant: why think that the structure of a thought, as a complex, isn't
  ...
  - (UC) isn't analytic
  - (UC) isn't synthetic a priori[fn:18]
...
- Negative Freedom: :: The power to act (or choose) without being
  causally determined by sensuous impulses[fn:13]
...
6. $\therefore$ There must exist a spontaneous cause -- one that is not
   determined by a prior ground. [Negation of 1][fn:14]
...
4. However, every initiation of a causal series presupposes a connection
   ...
   connection.[fn:16] [3, definition of causation]
...
- Open an 'entirely new field' of study concerning the nature of a
  /pure/ will and the capacity to motivated by reason alone[fn:13]
...
- There is some controversy as to what the actual first proposition is
  -- Kant does not explicitly state it[fn:14]
- Options:
...
- The third proposition is supposed to follow from the first two, but
  how?
- What is /respect/? Is it a feeling?[fn:16]
- If duty is an action from respect for the law, then isn't duty an
  action from feeling rather than reason?[fn:17]
...
- At the empirical 'level' we are (as are all living beings)
  psychologically determined[fn:13]
...
- The 'Incorporation Thesis'
  ...
  - Desires do /not/ determine rational choice/intentional action by
    ...
    - There is a question here whether intentional action is a status an
      ...
      (what Kant calls 'practical freedom')[fn:14]
  ...
  - The adoption of the maxim is not itself either causally connected to
    ...
    rather a 'spontaneous' and free act of the agent[fn:15]
...
- Two kinds of will
  ...
  - Finite (human) will: a will exposed to subjective and non-rational
    ...
    - Only finite wills have imperatives which apply to them[fn:17]
...
1. The Formula of Universal Law (FUL)[fn:20]

   - Variant: The Formula of the Law of Nature (FLN)[fn:21]

2. The Formula of Humanity as End in Itself (FH)[fn:22]
3. The Formula of Autonomy (FA)[fn:23]

   - Variant: The Formula of the Realm of Ends (FRE)[fn:24]
...
[fn:23] act according to maxims that can at the same time have as their
        object themselves as univeral laws of nature (4:437)

[fn:24] Act in accordance with the maxims of a universally legislative
...
- /Division/ (not /derivation/) of duties follows from the
  universalization procedure[fn:25]
...
[fn:25] It is easy to see that the first [contradiction in conception]
...
[fn:26] if the law can prescribe only the maxim of actions, not actions
...
- Two notions of 'autonomy'
  ...
  - Autonomy as a /property/ of the will[fn:27]
  - Autonomy as a /principle/ of the will[fn:28]

- All rival ethical theories place the principle of morality in some
  source other than (the structure of) the will -- they are
  'heteronomous' for that reason[fn:29]

[fn:27] Autonomy of the will is the characteristic of the will by which
        it is a law to itself (independent of any characteristic of the
        objects of willing). (4:440)

[fn:28] The principle of autonomy is thus: not to choose in any other
...
[fn:29] If it is /in anything other/ than the fitness of its maxims for
...
- We break out of the circle by appealing to the spontaneity of
  ...
  - Reasoning in accordance with rational principles cannot be
    ultimately determined by preceding events[fn:13]
...
- Prolegomena: §§6-10, §13 ([[file:static/materials/readings 1/kant-prolegomena-6-10-13.pdf][Hatfield 32-5, 37-8]])
...
*** DRAFT The Ideality of Space (and Time)
SCHEDULED: <2018-08-28 Tue>
:PROPERTIES:
  :EXPORT_HUGO_TAGS: idealism space time intuition incongruent-counterparts
  :EXPORT_FILE_NAME: transcendental-aesthetic
  :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :type post :nocite '(@guyer2014 @allison2004 @gardner1999 @vancleve1999 @messinaForthcoming @hanna2005)
  :END:
...
correspondingly time) exists independently of any possible /object/
...
rather a product of our subjective apprehension of objects that are distinct
from us. It is, in Kant's phrase, a 'form of intuition'.
...
where does this representation of space come from? Third, Kant is concerned
...
(or a point) in the first argument is that we cannot represent one object as
/distant/ from another without already representing them as being in one space
in which they may be related. Kant's second argument is perhaps less
persuasive, for it argues that we cannot represent a lack of space. Certainly,
this fact would seem to go against the empiricist view of space as something
we learn from experience. But it seems that the empiricist might counter that
once the representation of space is gained via experience, we cannot part with
it psychologically, and so cannot represent its absence.
...
representation of space is intellectual. According to Kant, spatial
representation is not fundamentally intellectual or conceptual, but rather
'intuitive'. This is not to say that spatial representation is /sensory/. We do
not have a sensory representation of an infinite space! Kant is trying to
carve out room for a position according to which we have a non-sensory but
also non-conceptual/intellectual representation of an infinite space, which
makes possible our representation of particular spatial expanses. There are
...
"B-edition" of 1787. It is not clear, however, what the significance of the
argument actually is. Is it an argument concerning the status of the
representation of space as ultimately an a priori intuition? Is it an argument
concerning the dependence of the science of geometry on space so understood?
Is it an argument concerning something else entirely?
...
supposedly being followed in the /Critique/.[fn:30] So appeal to the
...
i.e., that it is /nothing other than/ a pure a priori intuition.[fn:31]
...
[fn:30] See [@gava2013] for further discussion.

[fn:31] [@shabel2004, 207].
...
particular.[fn:32] In Kant's terminology space is /ideal/ in virtue of being
...
[fn:32] For further discussion see [@jauernig2008; @janiak2012; @messinaForthcoming].
...
The /Prolegomena/'s conclusion that consideration of incongruent counterparts
demonstrates that space is ideal is deeply contested. The conclusion is not
the only thing that is contested, unfortunately, for it is not at all clear
how the argument goes. The passage is below:
...
*** DRAFT The Metaphysical Deduction of the Categories
SCHEDULED: <2018-09-11 Tue>
:PROPERTIES:
  :EXPORT_HUGO_TAGS: categories metaphysics judgment logic understanding
...
Kant's aim in the so-called "Metaphysical Deduction" (see B159) is to argue
...
theory of the manner in which the structure of the rational human mind governs
the kinds of things it can know of reality. In many ways this work anticipates
...
metaphysics (though he does not call them categories) via an analysis of the
faculty of understanding (or "intellect" more broadly). He says,
...
Here Kant articulates (or perhaps "gestures at" is more accurate)
his view of how the concepts of metaphysics, through which we think of the
intelligible world, are acquired. They are acquired by attending to the
actions of the mind in course of its having experience. Here it is important
for Kant's project in the /Dissertation/, as it will be for his project in the
/Critique of Pure Reason/, that his account of the acquisition of the concepts
of metaphysics not run afoul of his characterization of those concepts as
"intellectual" rather than "empirical" or "sensitive."[fn:1533403059] For this
reason they cannot be concepts abstracted from sensible intuition, in the
manner that our concepts of space and time are. In such a case those concepts
...
is, however, some question as to whether, in the /Dissertation/ or in lectures
immediately subsequent to its publication, Kant in fact succeeds in providing
an account of the acquisition of such concepts consistent with his stricture
on their intellectual provenance.

The account of the /Dissertation/ puts pressure on Kant to provide some story as
to how we can come to be aware of the mind and its acts, and on what basis
this awareness constitutes the acquisition of a non-sensory concept. At this
point in his career, Kant has not yet articulated his doctrine of "pure"
apperception as distinct from inner sense (more on this in the next set of notes).
So it looks as if, given his distinction between intuition and concept and
their related faculties, that it must be an inner intuition that accounts for
the acquisition of the concepts of metaphysics. However, if it /is/ inner
...
opposed to empirical (for even the "pure" concepts of space and time, though free
of sensation, are nevertheless sensitive on this account (ID §5, 2:393)).
...
substances, including the mind/soul [-@dyck2016, 330]. Second, that Kant's
...
[-@dyck2016, 330-1]. However, neither of these interpretive points are
...
contradicting himself at multiple points.[fn:1533403096]
...
/Dissertation/ might clarify his position. However, the lecture texts we have from the
...
are presented in sense experience.[fn:1533403127] And, as he does in the
...
presented, as outer things are, merely in terms of relations.[fn:1533403341]
...
or by analogy to our thought of anything else."[fn:1533403360]
...
facts seems a reasonably suspicion that Kant's various commitments in the 70s
...
Kant's revision of his /Dissertation/ strategy in then argument of the MD. 

[fn:1533403059] What are the "concepts of metaphysics" for Kant? Certainly they
...
[fn:1533403096] For consideration of the problem of self-consciousness in the 1770s
...
[fn:1533403127] For discussion of Kant's view that the objects of sense consist
        entirely of relations, or relational properties, see
        [@pereboom1991; @langton1998; -@langton2006; @mclear2017].

[fn:1533403341] There is also indication in the /Duisburg Nachlaß/, as there was
...
[fn:1533403360] [@laywine2005, 9]; see also [@carl1989, 91-2, 97; @kitcher2011,
        73-4; @wuerth2014, 104; @dyck2016, 335-8]. For criticism of
        Carl's, and to a lesser degree Laywine's, position see
        [@allison2015, 121-30].


**** The Logical & Real Uses of the Understanding

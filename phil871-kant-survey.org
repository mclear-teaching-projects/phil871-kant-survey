...
\newthought{The 'Nervus Probandi' of Achilles}:[fn:27]
...
- Kant: why think that the structure of a thought, as a complex, isn't
  ...
  - (UC) isn't analytic
  - (UC) isn't synthetic a priori[fn:29]

[fn:27] Nor will anyone venture to assert that this proposition allows
...
[fn:28] Without a presupposed condition from any inclination, I connect
...
[fn:29] Act only in accordance with that maxim through which you can at
...
4. However, every initiation of a causal series presupposes a connection
   ...
   connection.[fn:27] [3, definition of causation]
...
- The third proposition is supposed to follow from the first two, but
  how?
- What is /respect/? Is it a feeling?[fn:27]
- If duty is an action from respect for the law, then isn't duty an
  action from feeling rather than reason?[fn:28]

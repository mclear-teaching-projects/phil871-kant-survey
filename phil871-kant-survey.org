...
* Handouts                                                                      :noexport:
** DONE Handout Week 1 Kant's Project                                         :ignore:
:PROPERTIES:
...
- Empiricist theory of truth (Locke & Hume)[fn:4]
...
- Logical division by /differentia/ in terms of species/genus
  distinction\footnote{\textbf{Logical Division}:
  \includegraphics{/Users/Roambot/Pictures/ConceptDivision.jpg}}
  1. The division of a genus is /complete/ --- the various species of a
     genus, taken together, /exhaust/ the genus
  2. Membership in a species is /exclusive/ --- no species may be
     predicated of another
- Intensional conception of logical containment
  - /Content/: the group of intensional concepts (marks) that a concept
    "contains in" itself as components
  - /Extension/: the group of lower, or more specific, concepts a
    concept "contains under" itself
  - content & extension are related to one another /reciprocally/[fn:7]
- For one concept to 'contain' another is to have that concept as a
  ...
  to their (non-overlapping) /differentia/
...
- How are synthetic a priori judgments so much as possible?


**** Two Questions
1. How are synthetic a priori judgments possible?
...
*** References & Further Reading
  ...
  :CLASS: unnumbered
  :END:
#+nocite: @allison1973; @allison2004; @beck1955; @beck1969; @beck1972; @beck1978; @beck1978c; @gardner1999; lovejoy1906a; @van-cleve1999 
...
[fn:6] the predicate B belongs to the subject A as something that is
...
| Week \nbsp\nbsp | Date\nbsp\nbsp\nbsp | Material                                     |
|---------+---------+----------------------------------------------|
|       1 |    8.21 | Kant's Critical Project                      |
...
- (Optional) Van Cleve, "[[https://www.dropbox.com/s/xkwnhakotbmeuop/vancleve1999_necessity%2C_analyticity%2C_and_the_a_priori.pdf?dl=0][Necessity, Analyticity, and the A Priori]]"
...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :type post :nocite '(@allison1973 @allison2004 @beck1955 @beck1969 @beck1972 @beck1978 @beck1978c @gardner1999 lovejoy1906a @van-cleve1999) 
:END:
...
those with knowledge of prominent European philosophers of the 17^th and 18^th
...
of an analytic judgment? This is a disputed issue (cf. @anderson2005a;
...
*** DRAFT The Transcendental Deduction of the Categories
...
*** DRAFT The Schematism
*** DRAFT Principles of Experience
*** DRAFT The Analogies & Kant's Defense of Causation
**** The Second Analogy
  :PROPERTIES:
...
*** DRAFT Reason & Transcendental Illusion
*** DRAFT The Paralogisms of the Soul
*** DRAFT The Antinomies & Transcendental Freedom
*** DRAFT The Project of the /Groundwork/ 
*** DRAFT The Will & Acting from Maxims
*** DRAFT The Formulations of the Categorical Imperative
*** DRAFT Autonomy & Freedom
*** DRAFT Reason's Unity

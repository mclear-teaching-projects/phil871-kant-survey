...
\newthought{The 'Nervus Probandi' of Achilles}:[fn:24]
...
- Kant: why think that the structure of a thought, as a complex, isn't
  ...
  - (UC) isn't analytic
  - (UC) isn't synthetic a priori[fn:26]

[fn:24] Nor will anyone venture to assert that this proposition allows
...
[fn:25] Without a presupposed condition from any inclination, I connect
...
[fn:26] Act only in accordance with that maxim through which you can at
...
4. However, every initiation of a causal series presupposes a connection
   ...
   connection.[fn:24] [3, definition of causation]
...
- The third proposition is supposed to follow from the first two, but
  how?
- What is /respect/? Is it a feeling?[fn:24]
- If duty is an action from respect for the law, then isn't duty an
  action from feeling rather than reason?[fn:25]
...
- Two kinds of will
  ...
  - Finite (human) will: a will exposed to subjective and non-rational
    ...
    - Only finite wills have imperatives which apply to them[fn:25]
...
1. The Formula of Universal Law (FUL)[fn:28]

   - Variant: The Formula of the Law of Nature (FLN)[fn:29]

2. The Formula of Humanity as End in Itself (FH)[fn:30]
3. The Formula of Autonomy (FA)[fn:31]

   - Variant: The Formula of the Realm of Ends (FRE)[fn:32]
...
[fn:28] DEFINITION NOT FOUND.

[fn:29] DEFINITION NOT FOUND.

[fn:30] DEFINITION NOT FOUND.

[fn:31] act according to maxims that can at the same time have as their
        object themselves as univeral laws of nature (4:437)

[fn:32] Act in accordance with the maxims of a universally legislative
...
- /Division/ (not /derivation/) of duties follows from the
  universalization procedure[fn:33]
...
[fn:33] It is easy to see that the first [contradiction in conception]
...
[fn:34] if the law can prescribe only the maxim of actions, not actions
...
- Two notions of 'autonomy'
  ...
  - Autonomy as a /property/ of the will[fn:35]
  - Autonomy as a /principle/ of the will[fn:36]

- All rival ethical theories place the principle of morality in some
  source other than (the structure of) the will -- they are
  'heteronomous' for that reason[fn:37]

[fn:35] Autonomy of the will is the characteristic of the will by which
        it is a law to itself (independent of any characteristic of the
        objects of willing). (4:440)

[fn:36] The principle of autonomy is thus: not to choose in any other
...
[fn:37] If it is /in anything other/ than the fitness of its maxims for
...
[fn:24] Whoever wills the end also wills (in so far as reason has
...
supposedly being followed in the /Critique/.[fn:38] So appeal to the
...
i.e., that it is /nothing other than/ a pure a priori intuition.[fn:39]
...
[fn:38] See [@gava2013] for further discussion.

[fn:39] [@shabel2004, 207].
...
particular.[fn:40] In Kant's terminology space is /ideal/ in virtue of being
...
[fn:40] For further discussion see [@jauernig2008; @janiak2012; @messinaForthcoming].
...
than "empirical" or "sensitive."[fn:41] For this reason they cannot be
...
contradicting himself at multiple points.[fn:42]
...
are presented in sense experience.[fn:43] And, as he does in the
...
presented, as outer things are, merely in terms of relations.[fn:44]
...
or by analogy to our thought of anything else."[fn:45]
...
[fn:41] What are the "concepts of metaphysics" for Kant? Certainly they
...
[fn:42] For consideration of the problem of self-consciousness in the 1770s
...
[fn:43] For discussion of Kant's view that the objects of sense consist
        entirely of relations, or relational properties, see
        [@pereboom1991; @langton1998; -@langton2006; @mclear2017].

[fn:44] There is also indication in the /Duisburg Nachlaß/, as there was
...
[fn:45] [@laywine2005, 9]; see also [@carl1989, 91-2, 97; @kitcher2011,
...
Kant does not provide convincing proof of this position in the MD. Whether such a proof could be given is, perhaps, another story.[fn:46]

[fn:46] There are a variety of prominent attempts to defend Kant's position
...
Kant is concerned with how we might explain and justify the application of a priori concepts to objects of experience. But this question, as it stands, requires still sharper focus. We've seen what Kant means in his question concerning the /legitimacy/ of concepts in their application to the objects of experience. But what does Kant mean by "/experience/" [/Erfahrung/]? Our problem is that the notion of "experience," both in German and in English, is ambiguous and can mean any number of a variety of things---anything from the mere occurrence of sensation all the way to empirical judgment.[fn:47]
...
[fn:47] For a helpful discussion of different ways "experience" might be
...
[fn:49] The /locus classicus/ for the two-step interpretation is [@henrich1969]. Note that I am not endorsing any of the specifics of Henrich's account, e.g., that the second step of the Deduction consists in the comparatively trivial reminder that since human forms of intuition are spatio-temporal, the categories must be know to apply only to spatio-temporal objects.
...
It is not clear from this remark what the fundamental difference is between mathematical and philosophical analogy.[fn:50] He goes on to say that 
...
[fn:50] See [@callanan2008] for extensive discussion and citations.
...
[fn:51] Note that Kant's argument doesn't obviously affect a version of the Humean view that regards causal judgment as based on habituation due to there /being/ a temporal order amongst our representations. Kant's argument only affects the more robust view that we must /represent/ the temporal order amongst our representations for causal judgment to occur.
...
[fn:52] See A85/B117, A262/B318; /JL/ §6 9:94-5; Locke EHU II.XII.9,
...
[fn:53] This form of /empirical deduction/ would be insufficient for a priori concepts (A85-6/B118). So too would a demonstration of how rational beings were caused to possess the conceptual capacities in question. This would be a merely /physiological derivation/ (A86-7/B118-19).

...
\setmonofont[Mapping=tex-text,Scale=0.9]{SF Mono}
% Cool ampersand
\newcommand{\amper}{{\fontspec[Scale=.95]{$mainfont$}\selectfont\itshape\&}}
% icons
\defaultfontfeatures{
    Path = /usr/local/texlive/2023basic/texmf-dist/fonts/opentype/public/fontawesome/ }
...
\lfoot{\footnotesize \myauthor\ | $course$}
